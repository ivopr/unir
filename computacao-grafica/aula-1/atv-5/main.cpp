...
void EspecificaParametrosVisualizacao(void) {
	...
	//glOrtho(-65.0, 65.0, -65.0, 65.0, -400.0, 400.0);  //define projeção ortogonal
	gluPerspective(60,fAspect,0.5,500); //define projecao perspectiva
...
int main(int argc, char **argv) {
	...
	glutInitWindowPosition(
		(glutGet(GLUT_SCREEN_WIDTH) - 450) / 2,
